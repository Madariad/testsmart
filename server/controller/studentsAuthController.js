...
async function register(req, res) {
  try {
    const { first_name, last_name, age, gender,  email, phone_number, date_of_registration, password } = req.body;
    ...
    const insertUserSql = 'INSERT INTO students (first_name, last_name, age, gender,  email, phone_number, date_of_registration, password) VALUES (?, ?, ?, ?, ?, ?, ?, ?)';
    await query(insertUserSql, [first_name, last_name, age, gender,  email, phone_number,  date_of_registration, hashedPassword]);
